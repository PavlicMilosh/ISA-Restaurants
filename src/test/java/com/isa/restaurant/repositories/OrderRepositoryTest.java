...
public class OrderRepositoryTest
{
    ...
    public void setUp()
    {
        ...
        Waiter user = new Waiter("billRepositoryUser4l@gmail.com", "123321", "billUser4", "billUser4");
    ...
    public void testSave()
    {
        ...
        DishType dishType = new DishType(r1,"salate");
        Waiter user = new Waiter("billRepositoryUser41@gmail.com", "123321", "billUser4", "billUser4");
        userRepository.save(user);
        RestaurantTable table=tableRepository.save(new RestaurantTable());
    ...
    public void testFindById()
    {
        ...
        Order saved=orderRepository.save(order);
        Order getOrder=orderRepository.findById(saved.getId());
        Assert.assertEquals(getOrder, saved);
    }

    @Test
    public void testGetTableOrders()
    {
        Restaurant r1=restaurantRepository.save(new Restaurant("restoranOrder122","desc"));
        DishType dishType = new DishType(r1,"salate2");
        Waiter user = new Waiter("billRepositoryUser411@gmail.com", "123321", "billUser4", "billUser4");
        userRepository.save(user);
        RestaurantTable table=tableRepository.save(new RestaurantTable());
        Drink d1=drinkRepository.save(new Drink("Coca Cola 31","Gazirano pice",150.0, r1));
        Drink d2=drinkRepository.save(new Drink("Pepsi 31","Gazirano pice",150.0, r1));

        Dish di1=dishRepository.save(new Dish("dish1 31","desc",450.0,r1));
        Dish di2=dishRepository.save(new Dish("dish2 31","desc",600.0,r1));
        ...
        temp.add(saved);
        Set<Order> getOrders=orderRepository.getTableOrders(table.getId());
        Assert.assertEquals(getOrders, temp);
    }
