package com.isa.restaurant.security;
...
public class TokenUtils
{
    ...
    @Value("${isa.token.secret}")
    private String secret;

    @Value("${isa.token.expiration}")
    ...
    public String generateToken(UserDetails userDetails)
    {
        ...
        claims.put("authority", userDetails.getAuthorities()); //proveriti da li radi
